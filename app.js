...
const countriesOutput = document.getElementById("countries-output");
const countries = [
  ...
  { name: "Congo (Republic of the Congo)", code: "CG" },
...
function pickRandomCountry() {
  ...
  countriesOutput.innerHTML = `<div class="country-flag">${countryCodeToFlag(country.code)}</div><div class="country-name">${country.name}</div>`;
}
